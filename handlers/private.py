            ...
            [
                [
                    InlineKeyboardButton(
                        "➕ ❰ Grubuna Ekle ❱ ➕", url=f"https://t.me/Darkl3smusicbot?startgroup=true"
                    )
                ],
                [
                    InlineKeyboardButton(
                        "🔊 Grup", url="https://t.me/Darkl3sFederasyonu"
                    ),
                    InlineKeyboardButton(
                        "💬 Sohbet", url="https://t.me/Darkl3sFederasyonu"
                    )
                ],
                [
                    InlineKeyboardButton(
                    ...
                    InlineKeyboardButton(
                        "Grup 🇹🇷", url=f"https://t.me/Darkl3sFederasyonu"
                    )
                ]
